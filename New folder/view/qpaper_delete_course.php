                     ...
                     <table id="table" class="table table-striped table-bordered" style="max-width: 100%">  
                          ...
                          {    
                               ...
                               <tr>  
                                    ...
                                    <td class="del"><button type="button" id="'.$row["course_id"].'" name="delete" class="btn btn-danger btn-xs delete"><i class="fa fa-trash-o"></i></button></td>
...
$('.del').on('click', '.delete', function(){
  ...
  if(confirm("Are you sure you want to delete the course: \nRC "+id+"?"))
  {
    ...
    $.post('../view/course_delete.php' , {id:id} ,
      function(data) {
