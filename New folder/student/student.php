...
<head>
  ...
  <link rel="stylesheet" href="skin-yellow.css">
...
<div class="wrapper">
    ...
    <section class="sidebar"><br>
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="student.png" class="img-circle" alt="User Image" style="background-color: white">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active"><a class="header"><span>STUDENT ID <?php echo $var_value ?></span></a></li>
  ...
  <div class="content-wrapper"><br>
    <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="#"><i id="icon" class="fa fa-dashboard"></i>Student</a></li>
